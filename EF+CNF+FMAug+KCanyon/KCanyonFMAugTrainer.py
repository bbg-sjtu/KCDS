...
from utils import *
from Dataset import *
from Canyontrainable_models import *
import os
...
model = SDSEF_FM_KCanyonTrainable(dim=dim, hidden_dim=h, num_layers=l, K=K, SDSEF_FM_modelpath=SDSEF_FM_velocity_modelpath, x0s=x0s, x_star=x_star).to(device)
