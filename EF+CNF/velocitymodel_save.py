...
if __name__ == "__main__":
    ...
    for file_name in file_list1:
        model.load_state_dict(torch.load(f'models/SDSEF_FM_h{h}_l{l}/SDSEF_FM_{file_name}.pth'))
        modelpath = f'models/velocity_models/velocity_model_h{h}_l{l}_{file_name}.pth'
