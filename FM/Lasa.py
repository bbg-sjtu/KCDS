...
if __name__ == "__main__":
    ...
    filename = 'AnglePy'
    # filename = 'CShapePy'
    # filename = 'DoubleBendedLinePy'
    # filename = 'BendedLinePy'
    # filename = 'JShapePy'
    # filename = 'KhameshPy'
    # filename = 'LShapePy'
    # filename = 'Leaf_1Py'
    # filename = 'Leaf_2Py'
    # filename = 'LinePy'
    # filename = 'Multi_Models_1Py'
    # filename = 'Multi_Models_2Py'
    # filename = 'Multi_Models_3Py'
    # filename = 'Multi_Models_4Py'
    # filename = 'NShapePy'
    # filename = 'PShapePy'
    # filename = 'RShapePy'
    # filename = 'SaeghePy'
